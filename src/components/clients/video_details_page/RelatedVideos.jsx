...
const RelatedVideos = ({ videos }) => {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900/60 rounded-lg border border-neutral-100 dark:border-neutral-800 shadow-sm overflow-hidden flex flex-col">
      {/* Header */}
      <div className="px-3 py-3 border-b border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-800/50 flex items-center gap-2 sticky top-0 z-10">
        <Clapperboard
          size={16}
