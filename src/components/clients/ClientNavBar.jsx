...
import { STUDY_EVENTS } from "@/utils/studyEvents";
...
const ClientNavBar = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(STUDY_EVENTS.PING_SUCCESS, handleStudyUpdate);
    window.addEventListener(STUDY_EVENTS.ITEM_INCREMENTED, handleStudyUpdate);
    ...
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-out border-b ${
        scrolled
          ...
          : "bg-white/50 dark:bg-neutral-900/50 backdrop-blur-xl border-transparent"
      }`}
    >
      {/* Desktop Navigation */}
        ...
        <div className="flex items-center justify-between h-[68px]">
          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn ? (
              ...
              <Link
                to="/client/login"
                className="hidden lg:inline-flex items-center gap-2 h-10 px-5 text-[13px] font-semibold text-white dark:text-neutral-900 bg-neutral-900 dark:bg-white rounded-xl hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-all duration-300 group shadow-[0_1px_2px_rgba(0,0,0,0.1),0_4px_12px_rgba(0,0,0,0.1)] hover:shadow-[0_1px_2px_rgba(0,0,0,0.1),0_8px_24px_rgba(0,0,0,0.15)]"
              >
                <span>Đăng nhập</span>
                <ArrowRight
                  size={14}
      ...
      >
        <div
          ref={menuRef}
          className="px-4 sm:px-6 lg:px-8 py-4 bg-white/70 dark:bg-neutral-900/70 backdrop-blur-2xl"
        >
          ...
          <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-800">
            {isLoggedIn ? (
              <>
                <div className="flex items-center gap-3 px-4 py-3 mb-2 bg-neutral-50/80 dark:bg-neutral-800/80 rounded-xl">
                  {authUser?.avatar_url ? (
                    <img
                      src={authUser.avatar_url}
                      alt=""
                    ...
                    <div className="w-10 h-10 rounded-xl bg-neutral-900 dark:bg-neutral-700 flex items-center justify-center">
                ...
                <button
                  onClick={() => handleLogout(authUser?.email)}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl text-[14px] font-medium text-neutral-600 dark:text-neutral-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50/80 dark:hover:bg-red-900/20 transition-all duration-200"
                >
                  <LogOut size={16} />
                  <span>Đăng xuất</span>
                </button>
              ...
              <Link
                to="/client/login"
                onClick={() => setIsMenuOpen(false)}
                className="flex items-center justify-center gap-2 w-full py-3.5 text-[14px] font-semibold text-white dark:text-neutral-900 bg-neutral-900 dark:bg-white rounded-xl hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-all duration-300 shadow-[0_1px_2px_rgba(0,0,0,0.1),0_4px_12px_rgba(0,0,0,0.1)]"
              >
                <span>Đăng nhập</span>
                <ArrowRight size={14} />
              </Link>
