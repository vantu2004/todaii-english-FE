...
const TopicSection = ({ topics = [], onNavigate }) => {
  ...
  return (
    <section className="px-4 md:px-8 py-8 bg-surface-primary dark:bg-neutral-950">
      <div className="flex items-center gap-2 mb-6">
        <div className="w-1 h-5 bg-brand-500 rounded"></div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        {displayTopics.map((topic) => (
          <div
            ...
            className={`relative h-24 rounded-lg bg-gradient-to-br ${topic.color} p-4 flex flex-col justify-end cursor-pointer hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors group overflow-hidden border border-neutral-100 dark:border-neutral-800`}
          >
            <h4 className="text-neutral-900 dark:text-white font-semibold text-base leading-tight relative z-10 line-clamp-2">
              {topic.name}
            </h4>
