    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-100/50 dark:border-emerald-900/30 p-3.5 rounded-lg flex items-start gap-3">
          <div className="mt-0.5 bg-emerald-100/70 dark:bg-emerald-900/40 p-2 rounded-md text-emerald-600 dark:text-emerald-500 shrink-0">
            <BookText size={18} />
          </div>
          <div>
            <h3 className="font-semibold text-sm text-neutral-900 dark:text-white mb-1">
      ...
      {/* Notice Box */}
      <div className="p-3 border border-brand-100 dark:border-brand-900/30 bg-brand-50/30 dark:bg-brand-900/10 rounded-lg flex items-start gap-2.5">
