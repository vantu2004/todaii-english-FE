    ...
    <div className="space-y-4 animate-fade-in">
      <div className="bg-neutral-50/50 dark:bg-neutral-900/40 p-4 rounded-lg border border-neutral-200 dark:border-neutral-800 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 py-1">
          <div className="bg-white dark:bg-neutral-850 p-3 rounded-lg border border-neutral-200 dark:border-neutral-800 text-center">
            <p className="text-[10px] text-neutral-400 dark:text-neutral-500 mb-0.5">
              Thời gian
            </p>
            <p className="text-sm font-semibold text-neutral-800 dark:text-neutral-250">
              {duration} phút
            </p>
          </div>
          <div className="bg-white dark:bg-neutral-850 p-3 rounded-lg border border-neutral-200 dark:border-neutral-800 text-center">
      ...
      <div className="p-3 border border-red-150 dark:border-red-950/30 bg-red-50/30 dark:bg-red-950/10 rounded-lg flex items-start gap-3">
        <ShieldAlert
          className="text-red-550 dark:text-red-400 shrink-0 mt-0.5"
          size={16}
        />
        <p className="text-xs text-neutral-655 dark:text-neutral-450 leading-relaxed">
