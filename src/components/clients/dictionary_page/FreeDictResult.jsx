        ...
        >
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              {entry.phonetic && (
                <p className="mt-1.5 text-sm font-mono text-neutral-500 dark:text-neutral-400">
                  {entry.phonetic}
                </p>
              )}
            </div>
              ...
              <div key={mIdx}>
                ...
                <ul className="space-y-4">
                  {meaning.definitions?.map((def, dIdx) => (
                    <li
                      key={dIdx}
                      className="pl-3 border-l-2 border-brand-200 dark:border-brand-800"
                    >
                      {/* DEFINITION */}
                      ...
                      {/* EXAMPLE */}
                      {def.example && (
                        <div className="mt-2.5 rounded-lg bg-neutral-50 dark:bg-neutral-900/30 p-3 border border-neutral-100 dark:border-neutral-800">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          {def.synonyms.map((syn, sIdx) => (
                            <button
                              ...
                              className="px-2.5 py-1 rounded-md bg-neutral-100 dark:bg-neutral-800 hover:bg-brand-500 dark:hover:bg-brand-500 hover:text-white dark:hover:text-white text-xs font-semibold text-neutral-700 dark:text-neutral-300 transition"
                            >
                              {syn}
                            </button>
                          ))}
