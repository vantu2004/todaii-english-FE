    ...
    <div className="h-full bg-white text-gray-900 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden flex">
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.3 }}
          className="w-1/3 bg-gray-50 px-6 overflow-y-auto flex flex-col py-6"
        >
          {/* Title */}
          <div className="mb-4">
          ...
          <div className="space-y-2 mt-auto">
            <a
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-lg transition-all duration-200 text-sm"
            >
