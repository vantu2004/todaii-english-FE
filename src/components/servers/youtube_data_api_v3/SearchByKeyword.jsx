...
const SearchByKeyword = ({ videos, onClickVideo }) => {
  ...
  return (
    <div className="h-full bg-transparent text-gray-900 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex h-full">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {video.map((v, idx) => (
                      <div
                        ...
                        className="group cursor-pointer rounded-lg overflow-hidden bg-white border border-gray-200 hover:border-gray-400 transition-colors"
                      >
                        ...
                        <div className="p-3">
                          <h4 className="font-semibold text-sm line-clamp-2 text-gray-900 group-hover:text-gray-600 transition-colors">
                            {v.snippet.title}
                          </h4>
                  ...
                  <div className="space-y-2">
                    {video.map((v, idx) => (
                      <div
                        ...
                        className="flex gap-4 p-3 rounded-lg bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-400 transition-colors cursor-pointer group"
                      >
                        <img
                          src={v.snippet.thumbnails.high.url}
                          alt={v.snippet.title}
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-semibold text-sm line-clamp-2 text-gray-900 group-hover:text-gray-600">
                            {v.snippet.title}
                          </h4>
                          <p className="text-xs text-gray-600 mt-1">
                            {v.snippet.channel_title}
          ...
          <div className="w-1/3  pl-6">
            {playlist.length > 0 ? (
              <div>
                <h2 className="text-lg font-semibold mb-6 flex items-center gap-2 text-gray-900 sticky top-0 bg-white pb-4 z-10">
                  Playlists
                </h2>
                ...
                <div className="space-y-3">
                  {playlist.map((p, idx) => (
                    <div
                      ...
                      className="group rounded-lg overflow-hidden bg-white border border-gray-200 hover:border-gray-400 transition-colors cursor-pointer"
                    >
