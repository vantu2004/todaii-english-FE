      ...
      {onAutoGenerate && (
        <div className="flex items-center gap-3 flex-shrink-0">
          <button
            ...
            className={`w-full sm:w-auto px-4 sm:px-5 py-2.5 sm:py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-all text-sm sm:text-base ${
              isGenerating
